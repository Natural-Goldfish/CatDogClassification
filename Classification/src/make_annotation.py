...
_ANNO_SAVE_PATH = "data\\annotations"
_IMG_SAVE_PATH = "data\\images"
_KAGGLE_PATH = "data\\Kaggle"

class MakeAnnotation(object):
    def __init__(self):
        super().__init__()
        self.img_load_path = _KAGGLE_PATH
        self.img_save_path = _IMG_SAVE_PATH
        self.anno_save_path = _ANNO_SAVE_PATH

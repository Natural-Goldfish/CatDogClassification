...
def get_args():
    ...
    parser.add_argument('--annotation_path', default = 'data\\annotations')
    ...
    # For testing
    parser.add_argument('--test_model_name', default = 'Vgg16_20_checkpoint.pth')
    parser.add_argument('--test_image_path', default = "data\\samples",\
        help = "If you want to classify cats and dogs images using pre-trained model, put the images in this directory")
    parser.add_argument('--test_image_name', default = 'sample_0.jpg',\

...
The new images and annotation files which are generated by _make_annotation.py_ are saved to ```'data/images'``` and ```'data/annotations'``` for each. The annotation file format looks like below :   
...
```
This is a part of the _test_annotation.json_ and the following images are some of the dataset images.</br></br>

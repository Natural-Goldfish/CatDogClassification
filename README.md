...
As I said on the indroduction, I made 7 different classification models. All of the network architecture are based on _'VGG-16'_, but the depth of the network are the biggest differences. Starting with 2-layers, I stackted layers up to 6-layers. In the case of pre-trained VGG-16, only the classifier layer is changed.</br></br>
- **Loss**</br></br>
I used _CrossEntropyLoss_ in pytorch</br></br>
- **Optimizer**</br></br>
I used _SGD optimizer_ with the default momentum values. _Learning rate : 1e-3_</br></br>
